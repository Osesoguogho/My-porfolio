...
const Contact = () => {
  return (
    <div id="contact" className="flex flex-col justify-center items-center">
         <h2 className='text-[#e80ed6] text-2xl md:text-3xl lg:text-5xl font-bold text-center my-4 text-shadow'>CONTACT</h2>
        <div className="my-3">
        <a href="mailto:osesthedon@gmail.com, osesoguogho@gmail.com" className=' bg-blue-600 p-2 border-solid border-2 border-blue-500 flex justify-center items-center text-2xl font-bold'> Contact </a>
        </div>
