...
const ProjComponents = ({project}) => {
  ...
  return (
    <div>
        <div  className='w-[12rem] h-[15.5rem] rounded-lg m-5 p-4 border-2 text-white shadow-2xl transition-all gradient-background'>
    ...
    <div className='mt-2 font-bold'>{project.description.substring(0, 31)}.....
      <p onClick={()=>handleModalDisplay(project.id)} className='bg-blue-600 text-center rounded-md mt-2 cursor-pointer'>Read more</p>
    </div>
    <div className={``}>
    ...
    <div className='bg-green-700 mt-4 mb-1 text-center rounded-md py-[2px]'>
